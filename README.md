...
Two skills that give a repository its own simplification-scan skill and keep that skill honest as the repository changes.
...
- [deepseek-ai/deepseek-harness: dsh-find-simplifications](https://github.com/deepseek-ai/deepseek-harness/tree/master/.agents/skills/dsh-find-simplifications), the finished simplification-scan skill that the generated skills take their section structure and evidence bar from.
